...
public class PendingReviewPackageController {
    ...
    public PendingReviewPackageController(PendingReviewPackageServiceImpl pendingReviewPackageService) {
        this.pendingReviewPackageService = pendingReviewPackageService;
    }

    @GetMapping("/page")
    public IPage<PendingReviewPackage> findPage(@RequestParam(defaultValue = "1") Integer pageNum,
